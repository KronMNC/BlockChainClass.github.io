...
contract ElectionFact {
    ...
    mapping(string=>ElectDet) companyEmail;
    
    function createElect(string memory email,string memory election_name, string memory election_description) public{
        address newElect = new Election(msg.sender , election_name, election_description);
